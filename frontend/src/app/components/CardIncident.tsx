...
import performanceImg from '@/app/assets/CardIncident/performance.png';
  ...
  return (
    <section className="relative px-4 py-16 mx-auto max-w-7xl">
      ...
      <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-3">
        {[
          { icon: <Award className="w-6 h-6 text-cyan-400" />, label: "#1 Platform", value: "Informatika" },
          { icon: <TrendingUp className="w-6 h-6 text-green-400" />, label: "Graduates", value: "1000+" },
          { icon: <Users className="w-6 h-6 text-blue-400" />, label: "Partners", value: "50+" }
        ].map((stat, idx) => (
          <motion.div
            key={idx}
            ...
            className={`
              p-6 transition-all duration-300 border
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center flex-1 gap-3">
            ...
            <motion.p
              ...
              exit={{ opacity: 0, y: -20 }}
              className={`text-gray-300 ${GeistMono.className}`}
            >
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        >
          <p className={`mb-6 text-3xl font-semibold text-white ${GeistMono.className}`}>
