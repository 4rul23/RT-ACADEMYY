...
export const metadata: Metadata = {
  title: 'Dashboard - RT Academy',
  description: 'Dashboard pembelajaran RT Academy',
}
...
export default function DashboardLayout({
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[rgb(10,21,37)]">
      ...
      <div className={`relative min-h-screen w-full ${GeistMono.className}`}>
        {children}
      </div>
    </div>
  )
